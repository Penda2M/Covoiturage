"""
Django settings for sitecovoiturage project.
...
SECRET_KEY = 'j@5!1y%s=1!u^g%s!^%i4!7vb#prh)*9$z6i5bdm!7g(&b20sy'
...
ROOT_URLCONF = 'sitecovoiturage.urls'
...
WSGI_APPLICATION = 'sitecovoiturage.wsgi.application'
